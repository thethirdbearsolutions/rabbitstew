...
def run_group(genotypes: list, config: Optional[SimConfig] = None, start_seed: Optional[int] = None, record: bool = False, food_state: Optional[dict] = None, return_state: bool = False, food_seed: Optional[int] = None):
