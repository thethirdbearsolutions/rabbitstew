...
| **E1. both fail** | on ≥ 5 of 6 seeds, **both** populations fail D's test (window mean income below the basal cost 0.25 in the transient or recovery window, **or** `alive` below 12 of 60, **or** reaching 0) | neither body holds up |
| **E2. co-evolved bankrupt, designed not** | D's test mirrored: on ≥ 5 of 6 seeds the co-evolved population fails D's test while the designed population passes it | **reported with the falsifier (class C) as its strongest form**: the designed body won by outlasting. Added 2026-09-26 (RBT-92 adversary round 1, F4b; endorsed by the author of the §9 rulings): the former E read "co-evolved income < 0.25" alone as "both fail", so a co-evolved collapse beside a thriving comparator was mislabelled |
