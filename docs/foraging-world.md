...
**Six items.** The holistic population starved out at season 15 (37 deaths at season 11, two survivors that ate a twelfth of an item a season). The wheeled population, under the work cost, bottlenecked to 11 by season 17 with a positive mean gain of +0.32 and kept breeding: the first time the Pioneer side has been selected rather than merely sustained. Random lumps therefore bootstrap somewhere between six and twelve items in this disc; the wheels survive at six and die at three under the work cost, and live at three without it. The dense arms meanwhile crossed over at season 83: holistic mean gain +1.02 against wheeled +0.94.
