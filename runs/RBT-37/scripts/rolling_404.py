...
cfg = SimConfig.from_dict(json.load(open("runs/RBT-37/cap-404-ext/config.json"))["sim"])
cfg = replace(cfg, opponent_proxy=True)
g = Genotype.load("runs/RBT-37/cap-404-ext/holistic/best_gen0399.json")
...
json.dump({"radius": r, "geom_offset": p1.geom_offset, "rows": out}, open("runs/RBT-37/rolling-404ext.json", "w"), indent=1)
