...
# Afterwards: python runs/RBT-92/tables.py runs/RBT-100/founders6-SEED  (seasons.txt is what the readout reads)
set -e
SEED=$1
...
exec python -m rabbitstew.cli ecology --seasons 60 --capacity 60 --challenge foraging --group-size 4 --workers "${WORKERS:-1}" \
