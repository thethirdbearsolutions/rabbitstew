"""Scratch for RBT-23: four copies of a best share one depleting arena (12 items, no regrowth), as in
...
for kind in ("holistic", "conventional"):
    for gen in gens:
        ...
        for mode in ("intact", "no_food"):
            ...
            print(f"{kind:12s} g{gen:3d} x4 {mode:8s} group {m['group_first']+m['group_second']:.2f}/{N_ITEMS} ({m['group_first']:.2f}+{m['group_second']:.2f})  robot0 {m['r0_first']+m['r0_second']:.2f} ({m['r0_first']:.2f}+{m['r0_second']:.2f}) work {m['r0_work']:.1f}kJ", flush=True)
