# RBT-103 adversary: the harness exactly as committed at 1be81c3 (14:31), BEFORE the 15:02 body-plan fix (c42e4f7). Unmodified below this line except for this comment and the _ROOT depth (it lives one directory deeper).
...
_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(_HERE)))  # adversary: one level deeper
