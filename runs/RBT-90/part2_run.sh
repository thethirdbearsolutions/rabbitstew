...
# --workers 1 because ten arms run side by side on ten cores; WORKERS=4 on a four-core cloud session
# (coordinator ruling 2026-09-26: workers 1 and 4 write byte-identical lineage.jsonl and cohorts.jsonl,
# checked on seed 801 before any arm). save_genomes is the default (on).
#
